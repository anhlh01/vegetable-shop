...
public class DeleteProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TblOrderDetailsDAO daoDetail = new TblOrderDetailsDAO();
            if (daoDetail.findOrderId(id)) {
                request.setAttribute("ERROR_MESSAGE", "The product is in the order detail. Can not remove!");
            } else {
